...
def start(email: str):
    try:
        ...
        r = s.post(
            "https://www.deezer.com/ajax/gw-light.php?method=deezer.getUserData&input=3&api_version=1.0&api_token=&cid="
        )
        ...
        api = s.post(
            "https://www.deezer.com/ajax/gw-light.php", params=params, data=data
        )
